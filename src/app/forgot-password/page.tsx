    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative w-full max-w-[440px] animate-in">
        <div className="bento-card p-10 md:p-12">
          ...
          {!success ? (
            <form className="mt-10 space-y-6" action={resetPassword}>
              <p className="text-center text-sm text-balance text-muted-foreground leading-relaxed">
                Insira seu e-mail institucional para receber as instruções de recuperação.
              </p>
            ...
            <div className="mt-10 flex flex-col items-center text-center space-y-6">
              <div className="h-20 w-20 flex items-center justify-center rounded-full bg-primary/10 text-primary border border-primary/20">
                <Mail className="h-10 w-10" />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-foreground">Verifique seu e-mail</h3>
                <p className="text-sm text-muted-foreground leading-relaxed italic">
                  Enviamos um link de recuperação para o endereço informado. Verifique também sua pasta de spam.
                </p>
              </div>
              <Link 
                href="/login" 
                className="group relative flex w-full items-center justify-center overflow-hidden rounded-2xl border border-primary/30 py-4 px-4 text-xs font-black uppercase tracking-[0.2em] text-primary transition-all hover:bg-primary/5 active:scale-[0.98]"
              >
                Retornar ao Login
              </Link>
            </div>
