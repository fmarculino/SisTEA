...
*   💰 [Plano de Controle de Saldos e Limites de Contratos](file:///c:/Users/Cliente/Projetos/SisTEA/docs/planos/plano_controle_saldo_contratos.md) - Roteiro completo das etapas de implementação executadas para monitoramento ativo e progress bars reativas no Dashboard.
...
*   📈 [Estudo de Viabilidade: Controle de Saldos de Contratos e Itens](file:///c:/Users/Cliente/Projetos/SisTEA/docs/analises/estudo_controle_saldo_contratos.md) - Estudo técnico sobre concorrência, prevenção de race conditions, bloqueios no envio ao MS (BR-012) e lógica de vigências por aditivos (BR-013).
